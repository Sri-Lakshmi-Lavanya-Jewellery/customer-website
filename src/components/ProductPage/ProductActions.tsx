...
import { WHATSAPP_CONFIG, openWhatsApp } from '../../utils/whatsapp';
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      <button
        ...
        className={`w-full sm:w-auto font-semibold py-3 px-8 rounded-lg transition-colors flex items-center justify-center gap-2 ${
          inStock 
